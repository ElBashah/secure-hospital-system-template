...
const DataTable = ({tableData, headerData, keys, route, title}) => {
    ...
    return(
        <div className={`table-container center-hv`}>
            <div className={`font-title-x`} style={{color: COLORS.DARK, fontWeight: 600}}>{title || 'NO-TITLE-GIVEN'}</div>
            ...
            {tableData.length > 0 && 
                ...
                <FlatList
                    ...
                    renderItem={rowData => {
                        ...
                        return (
                            <div
                                onClick={() => navigate(route, { state: rowData})}
